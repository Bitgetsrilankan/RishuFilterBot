...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002339040199').split()]  # For Multiple Id Use One Space Between Each.
...
DATABASE_NAME = environ.get('DATABASE_NAME', "subsinhalabot")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'subcollection')
